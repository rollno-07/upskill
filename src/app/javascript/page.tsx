...
// Dynamically load the main JavaScript visualizer module to avoid SSR issues
const PrepApp = dynamic(() => import('@/modules/js/App'), { ssr: false });
